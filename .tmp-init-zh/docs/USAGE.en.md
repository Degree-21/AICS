...
- Chinese default: scripts/init-docs.sh <target_dir> zh [--force]
 - Install into your project's docs/ via git clone

```bash
# From your project root: include as a vendor folder and install into docs/
git clone https://github.com/Degree-21/AICS.git vendor/aics-docs
chmod +x vendor/aics-docs/scripts/init-docs.sh
# Copy docs into your project's docs/ (choose English or Chinese default)
